        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Vendas Promocionais', icon: 'fa fa-fw fa-search', routerLink: ['/sys/consulta-vendas'] },
                    { label: 'Consulta de Vendas', icon: 'fa fa-fw fa-refresh', routerLink: ['/sys/sincronizacao-vendas'] }
                ]
            },
            {
